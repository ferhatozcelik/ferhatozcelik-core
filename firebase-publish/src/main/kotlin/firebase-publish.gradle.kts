...
val pomName = "Firebase"
val pomDescription = "Easy Firebase integration for Android"
val libVersionName = versionProperties.getProperty("firebase") as String + if (isSnapshot) snapshotIdentifier else ""
val artifactName = "firebase"
